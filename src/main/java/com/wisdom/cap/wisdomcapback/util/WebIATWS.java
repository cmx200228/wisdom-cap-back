...
public class WebIATWS extends WebSocketListener {
	...
	private static final String appid = "8627a2f9";
	private static final String apiSecret = "MTg3ZTRjYTkwZWJlM2MwNDAyZTQzNjIy";
	private static final String apiKey = "e0f3f05fce831621feaf4a7fdc51f61f";
...
//                    Thread.sleep(intervel); //模拟音频采样延时
        ...
        if (resp != null) {
            ...
            if (resp.getData() != null) {
                ...
                if (resp.getData().getStatus() == 2) {
                    ...
                    Common.result = decoder.toString();
                    System.out.println("本次识别sid ==》" + resp.getSid());
                    decoder.discard();
                    webSocket.close(1000, "");
                    System.out.println("成功后关闭连接");
                    Common.isStop = true;
                }
    ...
    public void onClosed(WebSocket webSocket, int code, String reason) {
        ...
        System.out.println("closed关闭连接");
        thread.interrupt();
        // 关闭连接，释放资源
        webSocket.close(1000, null);
    }
    public static void getVoice(String path) throws Exception {
        file = path;
        // 构建鉴权url
        ...
        client.newWebSocket(request, new WebIATWS());
    }
